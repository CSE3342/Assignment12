...
public class my_languageParser extends Parser {
	...
	@Override
	public String getGrammarFileName() { return "my_language.g4"; }
	...
	public my_languageParser(TokenStream input) {
		super(input);
	...
	public static class ProgContext extends ParserRuleContext {
		...
		public List<TerminalNode> NEWLINE() { return getTokens(my_languageParser.NEWLINE); }
		public TerminalNode NEWLINE(int i) {
			return getToken(my_languageParser.NEWLINE, i);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof my_languageListener ) ((my_languageListener)listener).enterProg(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof my_languageListener ) ((my_languageListener)listener).exitProg(this);
		}
	}
	...
	public static class ExprContext extends ParserRuleContext {
		public TerminalNode INT() { return getToken(my_languageParser.INT, 0); }
		public List<ExprContext> expr() {
			return getRuleContexts(ExprContext.class);
		}
		public ExprContext expr(int i) {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof my_languageListener ) ((my_languageListener)listener).enterExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof my_languageListener ) ((my_languageListener)listener).exitExpr(this);
		}
	}
